...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port=20101 src/train_bash.py --deepspeed ./ours-script/ds_config_zero2.json \
    ...
    --output_dir path_to_save_stage1_model \
    --overwrite_cache \
    ...
    --ddp_timeout 180000 \
    --save_total_limit 10 \
    --tokenized_path path_to_save_stage1

# the command to run
# nohup bash 2_chatglm_train_stage1_lora.sh > 2_chatglm_train_stage1_lora.out & disown